...
const PMS_COLUMN_MAPPINGS = {
  ...
  pioneerrx: {
    ...
    prescriber_name: ['Prescriber', 'Prescriber Name', 'Doctor', 'Prescriber Full Name', 'Prescriber Full Name First then Last'],
    prescriber_fax: ['Prescriber Fax Number', 'Prescriber Fax', 'PrescriberFax', 'Fax Number'],
